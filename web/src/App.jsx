...
export default function App(){
  ...
  return (
    <div className="container">
      ...
      {tab==='admin' {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' && isAdmin && <AdminDashboard/>} isAdmin {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' && isAdmin && <AdminDashboard/>} <AdminDashboard/>} isAdmin {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' && isAdmin && <AdminDashboard/>} <AdminDashboard/>} isAdmin {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' && isAdmin && <AdminDashboard/>} <AdminDashboard/>} isAdmin {tab==='admin' && isAdmin && <AdminDashboard/>}{tab==='admin' && isAdmin && <AdminDashboard/>} <AdminDashboard/>}
    </div>
  )
}
